...
const DeleteChatPage = ({ onCloseDeleteChatPage, selectedUser }) => {
  const { deleteChatForBoth, deleteChatForSelf } = useContext(ChatContext);
    ...
    >
      ...
      <div className="flex justify-end gap-8">
        ...
        <button
          onClick={() => {
            if (deleteForBoth) {
              deleteChatForBoth(selectedUser._id);
              onCloseDeleteChatPage();
            } else {
              deleteChatForSelf(selectedUser._id);
              onCloseDeleteChatPage();
            }
          }}
